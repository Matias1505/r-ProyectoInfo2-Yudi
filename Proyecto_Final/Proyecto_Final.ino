...
// Configuración de tiempo entre lecturas de sensores
...
void escribirFechaHora(File &archivo, DateTime fecha) {
...
void loop() {
  ...
  File archivo = SD.open("SENSORES.txt", FILE_WRITE);
  if (archivo) {
    //Imprimimr la fecha en el archivo
    escribirFechaHora(archivo, fecha);
    //Imprimir valores de sensores en el archivo
